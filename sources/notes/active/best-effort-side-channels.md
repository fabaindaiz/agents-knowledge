...
about:
  - {do: "Add an outbound call — webhook, notification, analytics, cache invalidation", wrong_when: "propagating is what the language does if you write nothing, so the report can kill the work"}
