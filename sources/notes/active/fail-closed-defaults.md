...
about:
  - {do: "Choose a fallback for a config value, or \"fix\" one that looks out of date", wrong_when: "the absent-config case is a misconfigured deploy, not a normal one"}
rests_on: "Saltzer & Schroeder 1975, principle 2"
strength: "fifty years old"
our_evidence: "reasoned for the claim; its boundaries from occurrences"
---
