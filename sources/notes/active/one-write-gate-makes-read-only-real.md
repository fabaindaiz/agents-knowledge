...
about:
  - {do: "Point tooling, tests or exploration at a database you do not own", wrong_when: "\"read-only\" is a parameter a caller can flip, or a write path exists outside the gate"}
