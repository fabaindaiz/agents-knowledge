...
about:
  - {do: "Filter, balance or resample a training, evaluation or reporting population", wrong_when: "the filter is on something the process produced, so it selects on the outcome"}
