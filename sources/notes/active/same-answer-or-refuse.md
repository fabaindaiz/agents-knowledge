...
confidence: "measured"
phases: ["plan", "dataset", "tests", "review"]
...
about:
  - {do: "Add a cache, a faster reduction or a second source for an existing answer", wrong_when: "it is *almost* equivalent, and a tolerance chosen today makes the comparison pass"}
  - {do: "Add a way to load your own content, a preview, or a validator beside the product's reader", wrong_when: "the second path is exercised by nobody, so its drift is found in the field"}
rests_on: "Zinkevich; Breck et al. 2017; Humble & Farley 2010, build once"
strength: "well established"
our_evidence: "measured in two repositories; the removal half reasoned"
---
