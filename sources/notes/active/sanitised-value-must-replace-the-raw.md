...
about:
  - {do: "Clamp, default or validate a value into a new name", wrong_when: "the file now contains a visible guard, which is what a reviewer checks for — not whether its result is the one used"}
rests_on: "King 2019; LangSec shotgun parsing (2016)"
