...
about:
  - {do: "Change a schema, an API shape, a message format or an enum written to a store", wrong_when: "both versions are live during any rolling deploy, and rollback puts you there on purpose"}
