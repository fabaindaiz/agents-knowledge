...
about:
  - {do: "Add a gate, an audit rule or a CI step", wrong_when: "the glue reads the wrong stream or dies early, or its subjects vanish, and the check is a constant green"}
rests_on: "mutation testing, DeMillo et al. 1978"
