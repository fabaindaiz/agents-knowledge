...
about:
  - {do: "Add or review a kill switch or feature flag on a risky feature", wrong_when: "the switch was wired into the path that existed when it was written, and reads or a second writer were added later"}
rests_on: "Hodgson on feature toggles"
strength: "practice"
