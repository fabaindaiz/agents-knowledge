...
about:
  - {do: "Argue that a race is handled, using a lock, a semaphore or a singleton", wrong_when: "it is a *correctness* lock rather than an *efficiency* one, and a second replica is one operational change away"}
