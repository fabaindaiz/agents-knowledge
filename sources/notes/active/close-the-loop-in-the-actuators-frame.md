...
about:
  - {do: "Write a control loop, a follow or steer behaviour, or a threshold that switches a mode", wrong_when: "the error is measured in a frame the loop itself moves, or one threshold makes the mode chatter"}
