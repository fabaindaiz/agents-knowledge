...
about:
  - {do: "Write to two systems that cannot share a transaction, or decide when to ack a redelivered message", wrong_when: "the order was chosen by convenience, and the crash between the writes leaves the unrecoverable half"}
