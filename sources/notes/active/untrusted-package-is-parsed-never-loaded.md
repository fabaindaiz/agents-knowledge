...
about:
  - {do: "Accept a file, an archive or a package from a user or another system", wrong_when: "the general loader can build objects, or the size limit reads the archive's own claim about itself"}
