...
- .agents/method/prompt-context.md §Keeping the set versioned, so other copies can catch up §Version numbers, and the collision they would otherwise have §20. Nothing private travels, directly or by reconstruction
