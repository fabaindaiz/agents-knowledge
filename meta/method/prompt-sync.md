...
- meta/method/prompt-merge.md §Phase 2 — Classify every item (read-only). Report before writing. §Reconciling two divergent knowledge notes §Reconciling the headers
